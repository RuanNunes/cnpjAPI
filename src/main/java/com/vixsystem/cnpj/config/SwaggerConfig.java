...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.vixsystem.cnpj.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Para listar um determinado cnpj existente na receita federal",
